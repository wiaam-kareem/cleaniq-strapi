      ...
      [
        {
          ...
          to: `/settings/email`,
          async Component() {
            const { ProtectedSettingsPage } = await Promise.resolve().then(() => require(
              /* webpackChunkName: "email-settings-page" */
              "./Settings-c26753ff.js"
            ));
...
exports.admin = admin;
//# sourceMappingURL=index-34bc9fff.js.map
